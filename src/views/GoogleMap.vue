  ...
  <div class="page">
    ...
    <div class="container menu">
      ...
      <section class="section display pd-l-0 pd-r-0">
        ...
        <div class="container-input minimal"></div>
      ...
      <div class="content has-text-centered">
        <div class="summary">
          <div class="cancle-mappage">
            <button class="cancle-mappage" v-on:click="goBack()">กลับ</button>
          ...
          <router-link :to="{ name: 'address' }">
            <button class="submit-order" v-on:click="saveData()">ถัดไป</button>
          </router-link>
        </div>
      </div>
    </footer>
